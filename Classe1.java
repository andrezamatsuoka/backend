...
public class Classe1 {
    public static void main(String[] args) {
        Scanner scnInputUsuario = new Scanner(System.in); // cria o input de entrada via terminal do usuário
        System.out.println("Olá! Bem vindo a calculadora de Java. Digite o primeiro número a ser calculado e tecle: \"Enter\"");
        int intInputUsuario1 = scnInputUsuario.nextInt(); // nextInt serve para coletar números
        System.out.println("Digite o segundo número a ser calculado e tecle: \"Enter\"");
        int intInputUsuario2 = scnInputUsuario.nextInt(); 
        System.out.println("Digite o número da opção desejada e tecla: \"Enter\"");
